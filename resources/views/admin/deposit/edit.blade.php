                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 py-2">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">Time: {{ $deposit->created_at->format('d M Y') }} =
                                    </span class="fw-bold"> {{ $deposit->created_at->format('g:i A') }} </Span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('deposit.update', $deposit->id) }}" method="POST" class="forms-sample">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="amount" type="number" value="{{ $deposit->amount }}"
                                class="form-control @error('amount') is-invalid @enderror" id="amount" autocomplete="off"
                                placeholder="10000">
                            @error('amount')
